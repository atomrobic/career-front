...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://127.0.0.1:8000/api/api/jobs/", newJob);
  ...
  // Add this near the top of your Home component, after the initial state declarations
  const BgPattern = () => (
    <div className="fixed inset-0 z-0 opacity-20">
      ...
      <div className="absolute inset-0" style={{
        backgroundImage: `
          radial-gradient(circle at 2px 2px, #EC4899 1px, transparent 1px),
          radial-gradient(circle at 30px 30px, #8B5CF6 2px, transparent 2px)
        `,
        backgroundSize: '60px 60px',
        opacity: 0.3
      }}></div>
      <div className="absolute inset-0" style={{
        backgroundImage: `
          radial-gradient(circle at 15px 15px, #3B82F6 0.5px, transparent 0.5px),
          radial-gradient(circle at 45px 45px, #10B981 0.5px, transparent 0.5px)
        `,
        backgroundSize: '60px 60px',
        opacity: 0.2
      }}></div>
      <div className="absolute inset-0 animate-pulse" style={{
        backgroundImage: `
          radial-gradient(circle at 30px 30px, #F59E0B 0.5px, transparent 0.5px)
        `,
        backgroundSize: '60px 60px',
        opacity: 0.15
      }}></div>
  ...
  // Update the main return statement, add BgPattern right after the opening div
  return (
